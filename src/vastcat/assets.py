...
ASSET_LIBRARY: Dict[str, Asset] = {
    ...
    "crackstation_human": Asset(
        name="crackstation-human-only.txt",
        category="wordlists",
        url="https://crackstation.net/files/crackstation-human-only.txt.gz",
        filename="crackstation-human-only.txt.gz",
        decompress="gz",
        output_name="crackstation-human-only.txt",
        description="CrackStation human-only list — 64M real passwords (485MB compressed)",
    ),
    "crackstation": Asset(
        name="crackstation.txt",
        category="wordlists",
        url="https://crackstation.net/files/crackstation.txt.gz",
        filename="crackstation.txt.gz",
        decompress="gz",
        output_name="crackstation.txt",
        description="CrackStation full list — 1.49 billion unique passwords (15GB compressed)",
    ),
    ...
    "keyboard_walks": Asset(
        ...
        category="wordlists",
        url="https://raw.githubusercontent.com/danielmiessler/SecLists/master/Passwords/Keyboard-Walks/Keyboard-Combinations.txt",
        filename="Keyboard-Combinations.txt",
    ...
    # WiFi/WPA specific
    "wpa_top4800": Asset(
        name="probable-v2-wpa-top4800.txt",
        category="wordlists",
        ...
        output_name="probable-v2-wpa-top4800.txt",
        description="Probable v2 WPA top 4800 passwords",
    ),
    # Probable-Wordlists (sorted by probability)
    "probable_top207": Asset(
        name="Top207-probable-v2.txt",
        category="wordlists",
        url="https://raw.githubusercontent.com/berzerk0/Probable-Wordlists/master/Real-Passwords/Top207-probable-v2.txt",
        filename="Top207-probable-v2.txt",
        output_name="Top207-probable-v2.txt",
        description="Probable v2 top 207 passwords (by frequency)",
    ),
    "probable_top12k": Asset(
        name="Top12Thousand-probable-v2.txt",
        category="wordlists",
        url="https://raw.githubusercontent.com/berzerk0/Probable-Wordlists/master/Real-Passwords/Top12Thousand-probable-v2.txt",
        filename="Top12Thousand-probable-v2.txt",
        output_name="Top12Thousand-probable-v2.txt",
        description="Probable v2 top 12K passwords (by frequency)",
    ),
    "probable_top304k": Asset(
        name="Top304Thousand-probable-v2.txt",
        category="wordlists",
        url="https://raw.githubusercontent.com/berzerk0/Probable-Wordlists/master/Real-Passwords/Top304Thousand-probable-v2.txt",
        filename="Top304Thousand-probable-v2.txt",
        output_name="Top304Thousand-probable-v2.txt",
        description="Probable v2 top 304K passwords (by frequency, 2.7 MB)",
    ),
}
